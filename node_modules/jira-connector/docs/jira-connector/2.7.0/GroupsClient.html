...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GroupsClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GroupsClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>GroupsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="GroupsClient"><span class="type-signature"></span>new GroupsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/groups'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_groups.js.html">api/groups.js</a>, <a href="api_groups.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="findGroups"><span class="type-signature"></span>findGroups<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns groups with substrings matching a given query. This is mainly for use with the group picker, so the
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The request options to use in the Jira API.</p>
                <h6>Properties</h6>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>A string against which to match groups.  Leave this blank to return all groups.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>A string specifying groups to exclude.</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The maximum number of results to return.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the groups have been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_groups.js.html">api/groups.js</a>, <a href="api_groups.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the groups have been retrieved.</p>
</div>
