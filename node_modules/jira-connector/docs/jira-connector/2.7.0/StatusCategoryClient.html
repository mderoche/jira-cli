...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: StatusCategoryClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: StatusCategoryClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>StatusCategoryClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="StatusCategoryClient"><span class="type-signature"></span>new StatusCategoryClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/statuscategory'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_statusCategory.js.html">api/statusCategory.js</a>, <a href="api_statusCategory.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getAllStatusCategories"><span class="type-signature"></span>getAllStatusCategories<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of all statusCategories visible to the user</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_statusCategory.js.html">api/statusCategory.js</a>, <a href="api_statusCategory.js.html#line14">line 14</a>
    </li></ul></dd>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getStatusCategory"><span class="type-signature"></span>getStatusCategory<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Get a full representation of the statusCategory that has the given id or key.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>statusCategoryIdOrKey</code></td>
            ...
            <td class="description last"><p>A String containing a statusCategory id</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the statusCategory has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_statusCategory.js.html">api/statusCategory.js</a>, <a href="api_statusCategory.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the statusCategory has been retrieved.</p>
</div>
