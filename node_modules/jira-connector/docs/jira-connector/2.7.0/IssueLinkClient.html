...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: IssueLinkClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: IssueLinkClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>IssueLinkClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="IssueLinkClient"><span class="type-signature"></span>new IssueLinkClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/issueLink'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueLink.js.html">api/issueLink.js</a>, <a href="api_issueLink.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="createIssueLink"><span class="type-signature"></span>createIssueLink<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Creates an issue link between two issues. The user requires the link issue permission for the issue which will
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The options for the request sent to the Jira API</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>See <a href="https://docs.atlassian.com/jira/REST/latest/#d2e5010">https://docs.atlassian.com/jira/REST/latest/#d2e5010</a></p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the link has been created.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueLink.js.html">api/issueLink.js</a>, <a href="api_issueLink.js.html#line15">line 15</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the link has been created.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="deleteIssueLink"><span class="type-signature"></span>deleteIssueLink<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Deletes an issue link with the specified id. To be able to delete an issue link you must be able to view both
issues and must have the link issue permission for at least one of the issues.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The options used in the request to the Jira API</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The id of the link to delete.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the Issue Link has been deleted.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueLink.js.html">api/issueLink.js</a>, <a href="api_issueLink.js.html#line73">line 73</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the Issue Link has been deleted.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getIssueLink"><span class="type-signature"></span>getIssueLink<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Gets an issue link with the specified id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The id of the link to retrieve.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the Issue Link has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueLink.js.html">api/issueLink.js</a>, <a href="api_issueLink.js.html#line48">line 48</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the Issue Link has been retrieved.</p>
</div>
