...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: MyPermissionsClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: MyPermissionsClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>MyPermissionsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="MyPermissionsClient"><span class="type-signature"></span>new MyPermissionsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/mypermissions'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_myPermissions.js.html">api/myPermissions.js</a>, <a href="api_myPermissions.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getMyPermissions"><span class="type-signature"></span>getMyPermissions<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns all permissions in the system and whether the currently logged in user has them. You can optionally
provide a specific context to get permissions for (projectKey OR projectId OR issueKey OR issueId)</p>
<ul>
<li>When no context supplied the project related permissions will return true if the user has that permission in
ANY project</li>
<li>If a project context is provided, project related permissions will return true if the user has the permissions
in the specified project. For permissions that are determined using issue data (e.g Current Assignee), true will
be returned if the user meets the permission criteria in ANY issue in that project</li>
<li>If an issue context is provided, it will return whether or not the user has each permission in that specific
issue</li>
</ul>
<p>NB: The above means that for issue-level permissions (EDIT_ISSUE for example), hasPermission may be true when no
...
reporter, except in the context of a concrete issue, where the reporter is known.</p>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the permissions have been returned.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_myPermissions.js.html">api/myPermissions.js</a>, <a href="api_myPermissions.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the permissions have been returned.</p>
</div>
