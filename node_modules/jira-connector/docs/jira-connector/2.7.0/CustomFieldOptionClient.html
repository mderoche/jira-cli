...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CustomFieldOptionClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CustomFieldOptionClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>CustomFieldOptionClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="CustomFieldOptionClient"><span class="type-signature"></span>new CustomFieldOptionClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/customFieldOptions'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_customFieldOption.js.html">api/customFieldOption.js</a>, <a href="api_customFieldOption.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getCustomFieldOption"><span class="type-signature"></span>getCustomFieldOption<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a full representation of the Custom Field Option that has the given id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>fieldOptionId</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>A String containing an Custom Field Option id</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_customFieldOption.js.html">api/customFieldOption.js</a>, <a href="api_customFieldOption.js.html#line16">line 16</a>
    </li></ul></dd>
