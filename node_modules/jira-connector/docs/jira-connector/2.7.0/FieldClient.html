...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FieldClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FieldClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>FieldClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="FieldClient"><span class="type-signature"></span>new FieldClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/field'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_field.js.html">api/field.js</a>, <a href="api_field.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="createCustomField"><span class="type-signature"></span>createCustomField<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Creates a custom field using a definition (object encapsulating custom field data)</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The request options to send to Jira</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>See <a href="https://docs.atlassian.com/jira/REST/latest/#d2e3412">https://docs.atlassian.com/jira/REST/latest/#d2e3412</a></p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the custom field has been created.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_field.js.html">api/field.js</a>, <a href="api_field.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the custom field has been created.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getAllFields"><span class="type-signature"></span>getAllFields<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of all fields, both System and Custom</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_field.js.html">api/field.js</a>, <a href="api_field.js.html#line14">line 14</a>
    </li></ul></dd>
