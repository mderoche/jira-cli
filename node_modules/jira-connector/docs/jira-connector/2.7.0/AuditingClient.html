...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AuditingClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AuditingClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AuditingClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="AuditingClient"><span class="type-signature"></span>new AuditingClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/auditing'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_auditing.js.html">api/auditing.js</a>, <a href="api_auditing.js.html#line7">line 7</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="createAudit"><span class="type-signature"></span>createAudit<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The request options.</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>See <a href="https://docs.atlassian.com/jira/REST/latest/#d2e2557">https://docs.atlassian.com/jira/REST/latest/#d2e2557</a></p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the audit is created.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_auditing.js.html">api/auditing.js</a>, <a href="api_auditing.js.html#line53">line 53</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the audit is created.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getAudits"><span class="type-signature"></span>getAudits<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns auditing records filtered using provided parameters</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The filtering options for retrieving audits.</p>
                <h6>Properties</h6>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The number of record from which search starts</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Maximum number of returned results (if is limit is &lt;= 0 or &gt; 1000, it will be set do default
    value: 1000)</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Text query; each record that will be returned must contain the provided text in one of its
    fields</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Timestamp in past; 'from' must be less or equal 'to', otherwise the result set will be empty
    ...
    response</p></td>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the audits are retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_auditing.js.html">api/auditing.js</a>, <a href="api_auditing.js.html#line15">line 15</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the audits are retrieved.</p>
</div>
