...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GroupUserPickerClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GroupUserPickerClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>GroupUserPickerClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="GroupUserPickerClient"><span class="type-signature"></span>new GroupUserPickerClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/groupuserpicker'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_groupUserPicker.js.html">api/groupUserPicker.js</a>, <a href="api_groupUserPicker.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="findUsersAndGroups"><span class="type-signature"></span>findUsersAndGroups<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of users and groups matching query with highlighting. This resource cannot be accessed
anonymously.</p>
</div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>A string used to search username, Name or e-mail address</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether to show the avatar</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The custom field id, if this request comes from a custom field, such as a user
    picker. Optional.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The list of project ids to further restrict the search This parameter can occur
    multiple times to pass in multiple project ids. Comma separated value is not supported. This parameter is
    only used when fieldId is present.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>issueTypeId</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The list of issue type ids to further restrict the search. This parameter can
    ...
    only used when fieldId is present.</p></td>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the search is completed.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_groupUserPicker.js.html">api/groupUserPicker.js</a>, <a href="api_groupUserPicker.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the search is completed.</p>
</div>
