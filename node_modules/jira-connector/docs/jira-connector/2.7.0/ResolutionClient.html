...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ResolutionClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ResolutionClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ResolutionClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="ResolutionClient"><span class="type-signature"></span>new ResolutionClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/resolution'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_resolution.js.html">api/resolution.js</a>, <a href="api_resolution.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getAllResolutions"><span class="type-signature"></span>getAllResolutions<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of all resolutions visible to the user</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the resolutions have been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_resolution.js.html">api/resolution.js</a>, <a href="api_resolution.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the resolutions have been retrieved.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getResolution"><span class="type-signature"></span>getResolution<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Get a full representation of the resolution that has the given id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>resolutionId</code></td>
            ...
            <td class="description last"><p>A String containing a resolution id</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the resolution has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_resolution.js.html">api/resolution.js</a>, <a href="api_resolution.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the resolution has been retrieved.</p>
</div>
