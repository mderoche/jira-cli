...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: WorkflowClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: WorkflowClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>WorkflowClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="WorkflowClient"><span class="type-signature"></span>new WorkflowClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/workflow'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_workflow.js.html">api/workflow.js</a>, <a href="api_workflow.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getWorkflows"><span class="type-signature"></span>getWorkflows<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The name of the workflow to retrieve.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the workflow(s) have been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_workflow.js.html">api/workflow.js</a>, <a href="api_workflow.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the workflow(s) have been retrieved.</p>
</div>
