...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ProjectValidateClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ProjectValidateClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ProjectValidateClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="ProjectValidateClient"><span class="type-signature"></span>new ProjectValidateClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/projectvalidate'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_projectValidate.js.html">api/projectValidate.js</a>, <a href="api_projectValidate.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="validateProjectKey"><span class="type-signature"></span>validateProjectKey<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Validates a project key.  This endpoint is a little wonky, as it returns a list of errors as a valid response;
even if the key is invalid, it still returns a 200 response.
See <a href="https://docs.atlassian.com/jira/REST/latest/#d2e297">https://docs.atlassian.com/jira/REST/latest/#d2e297</a></p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The key of the project.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the key has been validated.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_projectValidate.js.html">api/projectValidate.js</a>, <a href="api_projectValidate.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the key has been validated.</p>
</div>
