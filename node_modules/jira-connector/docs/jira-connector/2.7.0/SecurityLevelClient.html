...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SecurityLevelClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SecurityLevelClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SecurityLevelClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="SecurityLevelClient"><span class="type-signature"></span>new SecurityLevelClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/securitylevel'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_securityLevel.js.html">api/securityLevel.js</a>, <a href="api_securityLevel.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getSecurityLevel"><span class="type-signature"></span>getSecurityLevel<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Get a full representation of the security level that has the given id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>securityLevelId</code></td>
            ...
            <td class="description last"><p>The id of the security level to retrieve</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the security level has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_securityLevel.js.html">api/securityLevel.js</a>, <a href="api_securityLevel.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the security level has been retrieved.</p>
</div>
