...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SettingsClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SettingsClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SettingsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="SettingsClient"><span class="type-signature"></span>new SettingsClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/settings'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_settings.js.html">api/settings.js</a>, <a href="api_settings.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getIssueNavColumns"><span class="type-signature"></span>getIssueNavColumns<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns the default system columns for issue navigator. Admin permission will be required.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_settings.js.html">api/settings.js</a>, <a href="api_settings.js.html#line35">line 35</a>
    </li></ul></dd>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="setBaseUrl"><span class="type-signature"></span>setBaseUrl<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Sets the base URL that is configured for this JIRA instance.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The new base url.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the base url has been set.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_settings.js.html">api/settings.js</a>, <a href="api_settings.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the base url has been set.</p>
</div>
