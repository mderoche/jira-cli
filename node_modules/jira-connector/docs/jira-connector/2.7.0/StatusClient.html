...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: StatusClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: StatusClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>StatusClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="StatusClient"><span class="type-signature"></span>new StatusClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/status'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_status.js.html">api/status.js</a>, <a href="api_status.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getAllStatuses"><span class="type-signature"></span>getAllStatuses<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of all statuses visible to the user</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when statuses have been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_status.js.html">api/status.js</a>, <a href="api_status.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when statuses have been retrieved.</p>
</div>
...
<span class="param-type">Promise</span>
    ...
    <h4 class="name" id="getStatus"><span class="type-signature"></span>getStatus<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Get a full representation of the status that has the given id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>statusId</code></td>
            ...
            <td class="description last"><p>A String containing a status id</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the status has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_status.js.html">api/status.js</a>, <a href="api_status.js.html#line34">line 34</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the status has been retrieved.</p>
</div>
