...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PasswordClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PasswordClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>PasswordClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="PasswordClient"><span class="type-signature"></span>new PasswordClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/password'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_password.js.html">api/password.js</a>, <a href="api_password.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getPasswordPolicy"><span class="type-signature"></span>getPasswordPolicy<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns user-friendly statements governing the system's password policy.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>hasOldPassword</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether or not the user will be required to enter their current
    password. Use false (the default) if this is a new user or if an administrator is forcibly changing another
    user's password.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the password policy has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_password.js.html">api/password.js</a>, <a href="api_password.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the password policy has been retrieved.</p>
</div>
