...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: JqlClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: JqlClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>JqlClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="JqlClient"><span class="type-signature"></span>new JqlClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/jql/autocompletedata'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_jql.js.html">api/jql.js</a>, <a href="api_jql.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getAutoCompleteData"><span class="type-signature"></span>getAutoCompleteData<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns the auto complete data required for JQL searches.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The options sent to the Jira API.  Ignored by this function.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the autocomplete data is returned.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_jql.js.html">api/jql.js</a>, <a href="api_jql.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the autocomplete data is returned.</p>
</div>
