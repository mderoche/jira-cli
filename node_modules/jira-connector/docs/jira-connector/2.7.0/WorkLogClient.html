...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: WorkLogClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: WorkLogClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>WorkLogClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="WorkLogClient"><span class="type-signature"></span>new WorkLogClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/worklog'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_worklog.js.html">api/worklog.js</a>, <a href="api_worklog.js.html#line5">line 5</a>
    </li></ul></dd>
