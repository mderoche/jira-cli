...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SearchClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SearchClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SearchClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="SearchClient"><span class="type-signature"></span>new SearchClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/search'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_search.js.html">api/search.js</a>, <a href="api_search.js.html#line5">line 5</a>
    </li></ul></dd>
...
<div class="description">
    <p>Searches for issues using JQL.</p>
<p>Sorting the jql parameter is a full JQL expression, and includes an ORDER BY clause.</p>
...
it with a minus.</p>
<p>By default, only navigable (<em>navigable) fields are returned in this search resource. Note: the default is
different in the get-issue resource -- the default there all fields (</em>all).</p>
<ul>
...
<li>-description - include navigable fields except the description (the default is *navigable for search)</li>
<li>*all,-comment - include everything except comments</li>
</ul>
<p>Expanding Issues in the Search Result: It is possible to expand the issues returned by directly specifying the
expansion on the expand parameter passed in to this resources.</p>
<p>For instance, to expand the &quot;changelog&quot; for all the issues on the search result, it is neccesary to specify
&quot;changelog&quot; as one of the values to expand.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The options for the search.</p>
                <h6>Properties</h6>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The JQL query string</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The index of the first issue to return (0-based)</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The maximum number of issues to return (defaults to 50). The maximum allowable
    value is dictated by the JIRA property 'jira.search.views.default.max'. If you specify a value that is
    higher than this number, your search results will be truncated.</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether to validate the JQL query</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>The list of fields to return for each issue. By default, all navigable fields are
    returned.</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>A list of the parameters to expand.</p></td>
        </tr>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>A list of the properties to include (5 max).</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called with the search results.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_search.js.html">api/search.js</a>, <a href="api_search.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved with the search results.</p>
</div>
