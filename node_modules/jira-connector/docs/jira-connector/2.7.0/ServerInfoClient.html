...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ServerInfoClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ServerInfoClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ServerInfoClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="ServerInfoClient"><span class="type-signature"></span>new ServerInfoClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/serverInfo'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_serverInfo.js.html">api/serverInfo.js</a>, <a href="api_serverInfo.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getServerInfo"><span class="type-signature"></span>getServerInfo<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns general information about the current JIRA server.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>doHealthCheck</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Whether to perform a health check on the server.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the server info has been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_serverInfo.js.html">api/serverInfo.js</a>, <a href="api_serverInfo.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the server info has been retrieved.</p>
</div>
