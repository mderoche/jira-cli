...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>JiraClient<span class="signature">(config)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="JiraClient"><span class="type-signature"></span>new JiraClient<span class="signature">(config)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
    ...
    version 2 is supported.</p></td>
        ...
        <tr>
            ...
            <td class="description last"><p>The authentication information used tp connect to Jira. Must contain EITHER username and password
    OR oauth information.  Oauth information will be used over username/password authentication.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The username of the user that will be authenticated. MUST be included
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The password of the user that will be authenticated. MUST be included
    if using username and password authentication.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The consumer key used in the Jira Application Link for oauth
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The private key used for OAuth security. MUST be included if using OAuth.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The VERIFIED token used to connect to the Jira API.  MUST be included if using
    OAuth.</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The secret for the above token.  MUST be included if using Oauth.</p></td>
        </tr>
...
<span class="param-type">Promise</span>
            ...
            <td class="description last"><p>Any function (constructor) compatible with Promise (bluebird, Q,...).
     Default - native Promise.</p></td>
        </tr>
...
<span class="param-type">Request</span>
            ...
            <td class="description last"><p>Any function (constructor) compatible with Request (request, supertest,...).
     Default - require('request').</p></td>
        </tr>
...
<span class="param-type"><a href="AgileBoardClient.html">AgileBoardClient</a></span>
...
<span class="param-type"><a href="AgileSprintClient.html">AgileSprintClient</a></span>
...
<span class="param-type">AuthClient</span>
...
<span class="param-type"><a href="GroupUserPickerClient.html">GroupUserPickerClient</a></span>
...
<span class="param-type"><a href="LicenseValidatorClient.html">LicenseValidatorClient</a></span>
...
<span class="param-type"><a href="PriorityClient.html">PriorityClient</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>projectCategory</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="ProjectCategoryClient.html">ProjectCategoryClient</a></span>
...
<span class="param-type"><a href="ProjectValidateClient.html">ProjectValidateClient</a></span>
...
<span class="param-type"><a href="WebhookClient.html">WebhookClient</a></span>
...
<span class="param-type"><a href="WorklogClient_.html">WorklogClient</a></span>
...
<dl class="details">
    ...
    <h4 class="name" id="buildAgileURL"><span class="type-signature"></span>buildAgileURL<span class="signature">(path)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<div class="description">
    <p>Simple utility to build a REST endpoint URL for the Jira Agile API.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The path of the URL without concern for the root of the REST API.</p></td>
        </tr>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="buildAuthURL"><span class="type-signature"></span>buildAuthURL<span class="signature">(path)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<div class="description">
    <p>Simple utility to build a REST endpoint URL for the Jira Auth API.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="buildWebhookURL"><span class="type-signature"></span>buildWebhookURL<span class="signature">(path)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<div class="description">
    <p>Simple utility to build a REST endpoint URL for the Jira webhook API.</p>
</div>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="makeRequest"><span class="type-signature"></span>makeRequest<span class="signature">(options, callback<span class="signature-attributes">opt</span>, successString<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="param-desc">
    <p>Resolved with APIs response or rejected with error</p>
</div>
