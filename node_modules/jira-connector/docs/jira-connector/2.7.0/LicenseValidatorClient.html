...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: LicenseValidatorClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: LicenseValidatorClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>LicenseValidatorClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="LicenseValidatorClient"><span class="type-signature"></span>new LicenseValidatorClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/licenseValidator'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_licenseValidator.js.html">api/licenseValidator.js</a>, <a href="api_licenseValidator.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="validateLicense"><span class="type-signature"></span>validateLicense<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>The license to validate.</p></td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the license has been validated, or fails to validate.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_licenseValidator.js.html">api/licenseValidator.js</a>, <a href="api_licenseValidator.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the license has been validated, or fails to validate.</p>
</div>
