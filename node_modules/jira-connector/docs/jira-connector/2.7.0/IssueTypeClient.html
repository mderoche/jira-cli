...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: IssueTypeClient</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: IssueTypeClient</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>IssueTypeClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="IssueTypeClient"><span class="type-signature"></span>new IssueTypeClient<span class="signature">(jiraClient)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Used to access Jira REST endpoints in '/rest/api/2/issuetype'</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueType.js.html">api/issueType.js</a>, <a href="api_issueType.js.html#line5">line 5</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getAllIssueTypes"><span class="type-signature"></span>getAllIssueTypes<span class="signature">(opts, callback<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<div class="description">
    <p>Returns a list of all issue types visible to the user</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>Called when the issue types have been retrieved.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueType.js.html">api/issueType.js</a>, <a href="api_issueType.js.html#line14">line 14</a>
    </li></ul></dd>
...
<div class="param-desc">
    <p>Resolved when the issue types have been retrieved.</p>
</div>
...
<div class="description">
    <p>Get a full representation of the issue type that has the given id.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last"><p>A String containing an issue type id</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api_issueType.js.html">api/issueType.js</a>, <a href="api_issueType.js.html#line34">line 34</a>
    </li></ul></dd>
