...
<p>Example:</p>
<pre class="prettyprint source lang-javascript"><code>var JiraClient = require('jira-connector');
...
<pre class="prettyprint source lang-javascript"><code>var JiraClient = require('./index.js');
...
<li>board (/rest/agile/1.0/board)<ul>
<li>getAllBoards</li>
<li>getBoard</li>
<li>getIssuesForBoard</li>
<li>getSprintsForBoard</li>
</ul>
</li>
...
<li>issue (/rest/api/2/issue and /rest/agile/1.0/issue)<ul>
<li>getIssue (agile api, set <code>opts.agile: true</code>)</li>
<li>getIssueEstimation (agile api)</li>
<li>setIssueEstimation (agile api)</li>
<li>setIssueRanks (agile api)</li>
<li>createIssue</li>
...
<li>sprint (/rest/agile/1.0/sprint)<ul>
<li>createSprint</li>
<li>getSprint</li>
<li>updateSprint</li>
<li>partiallyUpdateSprint</li>
<li>deleteSprint</li>
<li>getSprintIssues</li>
<li>moveSprintIssues</li>
<li>swapSprint</li>
</ul>
</li>
...
<li>webhook (/rest/webhooks/1.0/webhook)<ul>
<li>getAllWebhooks</li>
<li>getWebhook</li>
<li>createWebhook</li>
<li>deleteWebhook</li>
</ul>
